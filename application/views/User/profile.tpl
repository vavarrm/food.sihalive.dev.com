											...
											<form method="post"  class="rd-mailform form-contact-line text-left" >
												<div class="form-inline-flex">
													<div class="form-group">
														...
														<input id="o_fname" ng-model="u_fname"  type="text" placeholder="<{$userLanguageAry.user_delivery_phone}>" name="o_consignee"   data-constraints="@Required" class="form-control form-control-has-validation form-control-last-child">
												...
												<div class="form-inline-flex this-margin-top">
													...
													<div class="form-group">
														...
														<input id="o_phone" ng-model="u_email" type="text" placeholder="<{$userLanguageAry.user_delivery_phone}>" name="o_phone" data-constraints="@Required" class="form-control form-control-has-validation form-control-last-child"><span class="form-validation"></span>
													</div>
												</div>
												<div class="form-inline-flex this-margin-top">
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input id="o_email" ng-model="u_cofirm_pwd" type="text" placeholder="<{$userLanguageAry.user_delivery_phone}>" name="o_phone" data-constraints="@Required" class="form-control form-control-has-validation form-control-last-child"><span class="form-validation"></span>
													</div>
												</div>
