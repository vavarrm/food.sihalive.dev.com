                                            ...
                                            <div class="col-sm-3 text-xs-center">
                                                <div class="right-content bg-white">
                                                    <div class="right-review">
                                                        ...
                                                        <p> 245 Reviews</p> <a href="/restaurant" class="btn btn-sm​​​​​​​​​​​ this-hover-text-deep-orange this-text-deep-orange" style="border: dashed 1px orangered;">View Menu</a> </div>
                                                </div>
                                                <!-- end:right info -->
                                            </div>
                                        </div>
