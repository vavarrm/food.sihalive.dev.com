...
include __DIR__ . '/vendor/Connection.php';
...
$context = array(
    'ssl' => array(
        'local_cert' => 'D:\wamp64\bin\apache\apache2.4.27\conf\ssl\localhost.crt',
        'local_pk'   => 'D:\wamp64\bin\apache\apache2.4.27\conf\ssl\localhost.key',
    )
);
$sender_io = new SocketIO(2120, $context);
$db = new Workerman\MySQL\Connection('127.0.0.1', '3306', 'root', 'root', 'sihalive');
