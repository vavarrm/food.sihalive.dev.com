...
function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function(a) {
        ...
        $("ul:first", t).slideUp(function() {
            e()
        })) : (t.parent().is(".child_menu") ? $BODY.is(".nav-sm") && ($SIDEBAR_MENU.find("li").removeClass("active active-sm"),
...
function init_flot_chart() {
    if (void 0 !== $.plot) {
        xxx("init_flot_chart");
        for (var e = [[gd(2012, 1, 1), 17], [gd(2012, 1, 2), 74], [gd(2012, 1, 3), 6], [gd(2012, 1, 4), 39], [gd(2012, 1, 5), 20], [gd(2012, 1, 6), 85], [gd(2012, 1, 7), 7]], a = [[gd(2012, 1, 1), 82], [gd(2012, 1, 2), 23], [gd(2012, 1, 3), 66], [gd(2012, 1, 4), 9], [gd(2012, 1, 5), 119], [gd(2012, 1, 6), 6], [gd(2012, 1, 7), 9]], t = [], n = 0; n < 30; n++)
            t.push([new Date(Date.today().add(n).days()).getTime(), randNum() + n + n + 10]);
        var o = {
            grid: {
                show: !0,
                aboveData: !0,
        ...
        $("#chart_plot_01").length && (xxx("Plot1"),
        ...
        $("#chart_plot_02").length && (xxx("Plot2"),
        $.plot($("#chart_plot_02"), [{
            label: "Email Sent",
            data: t,
            lines: {
        ...
        $("#chart_plot_03").length && (xxx("Plot3"),
        $.plot($("#chart_plot_03"), [{
            label: "Registrations",
...
function init_starrr() {
    "undefined" != typeof starrr && (xxx("init_starrr"),
    $(".stars").starrr(),
...
function init_JQVmap() {
    void 0 !== jQuery.fn.vectorMap && (xxx("init_JQVmap"),
...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (xxx("init_chart_doughnut"),
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        xxx("init_gauge [" + $(".gauge-chart").length + "]"),
        xxx("init_gauge");
        var e = {
            lines: 12,
            angle: 0,
        ...
        if ($("#gauge-text").length && (t.maxValue = 6e3,
        t.animationSpeed = 32,
        t.set(3200),
        t.setTextField(document.getElementById("gauge-text"))),
        $("#chart_gauge_02").length)
            var n = document.getElementById("chart_gauge_02")
              , o = new Gauge(n).setOptions(e);
        $("#gauge-text2").length && (o.maxValue = 9e3,
        o.animationSpeed = 32,
        o.set(2400),
        o.setTextField(document.getElementById("gauge-text2")))
    }
}
function init_sparklines() {
    void 0 !== jQuery.fn.sparkline && (xxx("init_sparklines"),
...
function init_select2() {
    "undefined" != typeof select2 && (xxx("init_toolbox"),
...
function init_wysiwyg() {
    function e(e, a) {
        var t = "";
        "unsupported-file-type" === e ? t = "Unsupported format " + a : xxx("error uploading file", e, a),
        $('<div class="alert"> <button type="button" class="close" data-dismiss="alert">&times;</button><strong>File upload error</strong> ' + t + " </div>").prependTo("#alerts")
    }
    void 0 !== $.fn.wysiwyg && (xxx("init_wysiwyg"),
    ...
    if (void 0 !== $.fn.cropper) {
        ...
        e.on({
            ...
            "crop.cropper": function(e) {
                xxx(e.type, e.x, e.y, e.width, e.height, e.rotate, e.scaleX, e.scaleY)
            },
        ...
        void 0 === a[0].download && a.addClass("disabled"),
        $(".docs-toggles").on("change", "input", function() {
            var a, t, n = $(this), o = n.attr("name"), r = n.prop("type");
            e.data("cropper") && ("checkbox" === r ? (d[o] = n.prop("checked"),
            a = e.cropper("getCropBoxData"),
            t = e.cropper("getCanvasData"),
            d.built = function() {
                e.cropper("setCropBoxData", a),
                e.cropper("setCanvasData", t)
            }
            ) : "radio" === r && (d[o] = n.val()),
            e.cropper("destroy").cropper(d))
        }),
        $(".docs-buttons").on("click", "[data-method]", function() {
            var t, n, o = $(this), r = o.data();
            if (!o.prop("disabled") && !o.hasClass("disabled") && e.data("cropper") && r.method) {
                if (void 0 !== (r = $.extend({}, r)).target && (t = $(r.target),
                void 0 === r.option))
                    try {
                ...
                switch (n = e.cropper(r.method, r.option, r.secondOption),
                r.method) {
                case "scaleX":
                case "scaleY":
                ...
                case "getCroppedCanvas":
                    n && ($("#getCroppedCanvasModal").modal().find(".modal-body").html(n),
                    a.hasClass("disabled") || a.attr("href", n.toDataURL()))
                }
                if ($.isPlainObject(n) && t)
                    try {
        ...
        $(document.body).on("keydown", function(a) {
            if (e.data("cropper") && !(this.scrollTop > 300))
                switch (a.which) {
                case 37:
                    a.preventDefault(),
                    e.cropper("move", -1, 0);
        ...
        var c, u = $("#inputImage"), m = window.URL || window.webkitURL;
        m ? u.change(function() {
            var a, t = this.files;
            e.data("cropper") && t && t.length && (a = t[0],
            /^image\/\w+$/.test(a.type) ? (c = m.createObjectURL(a),
            e.one("built.cropper", function() {
                m.revokeObjectURL(c)
            }).cropper("reset").cropper("replace", c),
            u.val("")) : window.alert("Please choose an image file."))
        }) : u.prop("disabled", !0).parent().addClass("disabled")
    }
}
function init_knob() {
    if (void 0 !== $.fn.knob) {
        ...
        var e, a = 0, t = 0, n = 0, o = $("div.idir"), r = $("div.ival");
        $("input.infinite").knob({
            min: 0,
            max: 20,
            stopper: !1,
...
function init_InputMask() {
    void 0 !== $.fn.inputmask && (xxx("init_InputMask"),
    $(":input").inputmask())
}
function init_ColorPicker() {
    void 0 !== $.fn.colorpicker && (xxx("init_ColorPicker"),
    $(".demo1").colorpicker(),
    $(".demo2").colorpicker(),
...
function init_IonRangeSlider() {
    void 0 !== $.fn.ionRangeSlider && (xxx("init_IonRangeSlider"),
...
function init_daterangepicker() {
    if (void 0 !== $.fn.daterangepicker) {
        xxx("init_daterangepicker");
        var e = function(e, a, t) {
            xxx(e.toISOString(), a.toISOString(), t),
        ...
        $("#reportrange").on("show.daterangepicker", function() {
            xxx("show event fired")
        }),
        $("#reportrange").on("hide.daterangepicker", function() {
            xxx("hide event fired")
        }),
        $("#reportrange").on("apply.daterangepicker", function(e, a) {
            xxx("apply event fired, start/end dates are " + a.startDate.format("MMMM D, YYYY") + " to " + a.endDate.format("MMMM D, YYYY"))
        }),
        $("#reportrange").on("cancel.daterangepicker", function(e, a) {
            xxx("cancel event fired")
        }),
...
function init_daterangepicker_right() {
    if (void 0 !== $.fn.daterangepicker) {
        xxx("init_daterangepicker_right");
        var e = function(e, a, t) {
            xxx(e.toISOString(), a.toISOString(), t),
...
function init_daterangepicker_single_call() {
    void 0 !== $.fn.daterangepicker && (xxx("init_daterangepicker_single_call"),
...
function init_daterangepicker_reservation() {
    void 0 !== $.fn.daterangepicker && (xxx("init_daterangepicker_reservation"),
...
function init_SmartWizard() {
    void 0 !== $.fn.smartWizard && (xxx("init_SmartWizard"),
    $("#wizard").smartWizard(),
...
function init_validator() {
    "undefined" != typeof validator && (xxx("init_validator"),
    ...
    $("form").submit(function(e) {
        e.preventDefault();
        var a = !0;
        return validator.checkAll($(this)) || (a = !1),
        a && this.submit(),
        !1
    }))
}
function init_PNotify() {
    "undefined" != typeof PNotify && (xxx("init_PNotify"),
    new PNotify({
        title: "PNotify",
        type: "info",
...
function init_EasyPieChart() {
    if (void 0 !== $.fn.easyPieChart) {
        ...
        $.fn.popover.Constructor.prototype.leave = function(e) {
            var t, n, o = e instanceof this.constructor ? e : $(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type);
            a.call(this, e),
...
function init_charts() {
    if (xxx("run_charts  typeof [" + typeof Chart + "]"),
    "undefined" != typeof Chart) {
        ...
        if ($("#mybarChart").length && (e = document.getElementById("mybarChart"),
        new Chart(e,{
            type: "bar",
            data: {
                labels: ["January", "February", "March", "April", "May", "June", "July"],
        ...
        $("#canvasRadar").length && (e = document.getElementById("canvasRadar"),
        a = {
        ...
        $("#pieChart").length && (e = document.getElementById("pieChart"),
        a = {
            datasets: [{
                data: [120, 50, 140, 180, 100],
                backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
        ...
        $("#polarArea").length && (e = document.getElementById("polarArea"),
        a = {
            datasets: [{
                data: [120, 50, 140, 180, 100],
                backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
...
function init_compose() {
    void 0 !== $.fn.slideToggle && (xxx("init_compose"),
...
function init_calendar() {
    if (void 0 !== $.fn.fullCalendar) {
        xxx("init_calendar");
        var e, a = new Date, t = a.getDate(), n = a.getMonth(), o = a.getFullYear(), r = $("#calendar").fullCalendar({
            header: {
            ...
            events: [{
                title: "All Day Event",
                start: new Date(o,n,1)
            }, {
                title: "Long Event",
                start: new Date(o,n,t - 5),
                end: new Date(o,n,t - 2)
            }, {
                title: "Meeting",
                start: new Date(o,n,t,10,30),
                allDay: !1
            }, {
                title: "Lunch",
                start: new Date(o,n,t + 14,12,0),
                end: new Date(o,n,t,14,0),
                allDay: !1
            }, {
                title: "Birthday Party",
                start: new Date(o,n,t + 1,19,0),
                end: new Date(o,n,t + 1,22,30),
                allDay: !1
            }, {
...
function init_morris_charts() {
    "undefined" != typeof Morris && (xxx("init_morris_charts"),
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        $("#echart_sonar").length && echarts.init(document.getElementById("echart_sonar"), e).setOption({
            title: {
        ...
        $("#echart_pyramid").length && echarts.init(document.getElementById("echart_pyramid"), e).setOption({
            title: {
        ...
        $("#echart_gauge").length && echarts.init(document.getElementById("echart_gauge"), e).setOption({
            tooltip: {
                formatter: "{a} <br/>{b} : {c}%"
            },
            toolbox: {
        ...
        $("#echart_line").length && echarts.init(document.getElementById("echart_line"), e).setOption({
            title: {
                text: "Line Graph",
                subtext: "Subtitle"
            },
        ...
        $("#echart_scatter").length && echarts.init(document.getElementById("echart_scatter"), e).setOption({
            title: {
                text: "Scatter Graph",
                subtext: "Heinz  2003"
            },
        ...
        $("#echart_bar_horizontal").length && echarts.init(document.getElementById("echart_bar_horizontal"), e).setOption({
            title: {
                text: "Bar Graph",
        ...
        $("#echart_pie2").length && echarts.init(document.getElementById("echart_pie2"), e).setOption({
            tooltip: {
                trigger: "item",
        ...
        $("#echart_donut").length && echarts.init(document.getElementById("echart_donut"), e).setOption({
            tooltip: {
                trigger: "item",
                formatter: "{a} <br/>{b} : {c} ({d}%)"
            },
        ...
        $("#echart_mini_pie").length && echarts.init(document.getElementById("echart_mini_pie"), e).setOption({
            title: {
                text: "Chart #2",
        ...
        $("#echart_world_map").length && echarts.init(document.getElementById("echart_world_map"), e).setOption({
            title: {
            ...
            tooltip: {
                ...
                formatter: function(e) {
                    var a = (e.value + "").split(".");
                    return a = a[0].replace(/(\d{1,3})(?=(?:\d{3})+(?!\d))/g, "$1,") + "." + a[1],
